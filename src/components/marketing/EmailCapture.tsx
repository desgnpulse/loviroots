        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 rounded-full px-5 py-3 bg-ivory/10 border border-ivory/20 text-ivory placeholder:text-ivory/40 focus:outline-none focus:ring-2 focus:ring-gold text-sm"
            />
            <button
              type="submit"
